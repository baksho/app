...
async def create_contact_message(message: ContactMessageCreate, db):
    """
...
async def get_contact_messages(db, limit: int = 100):
    """
...
async def get_contact_message(message_id: str, db):
    """
...
async def delete_contact_message(message_id: str, db):
    """
